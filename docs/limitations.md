...
- Source screening is not a substitute for the preregistered human perception pretest.
...
- Treatment effects may depend on the exact model ID, prompt wording, run date, and temperature.
